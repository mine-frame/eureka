...
public class EurekaBootStrap implements ServletContextListener {
     ...
     * todo 初始化环境变量，可以覆盖这个方法自己实现自己的环境变量方法。
     */
    protected void initEurekaEnvironment() throws Exception {
        logger.info("Setting the eureka configuration..");

        /**
         * todo double check 初始化一个实例变量。配置管理器初始化的一个过程【ConfigurationManager.getConfigInstance()】。单例模式。
         *      管理eureka的所有的配置，读取配置文件里的配置到内存供eureka server 运行使用。
         */
    ...
    /**
     * todo  服务器上下文的 init 钩子。覆盖自定义逻辑。
     * init hook for server context. Override for custom logic.
     */
    protected void initEurekaServerContext() throws Exception {
        // todo 第一步： 加载eureka-server.properties文件中的配置
        ...
        // todo 第二步：初始化eureka-server内部的一个eureka-client【用来跟其他的eureka-server节点注册和通信的】
        ...
        // todo 第四步： 处理PeerEurekaNodes节点相关的事情
        ...
        // todo 第五步： 完成eureka-server上下文【context】的构建以及初始化
