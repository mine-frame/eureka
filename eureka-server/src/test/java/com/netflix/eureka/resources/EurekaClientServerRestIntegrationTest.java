 ...
 * uncompressed).
 *
 * todo 在这个测试类里，会将eureka注册中心启动起来，然后模拟eureka客户端【服务】去发送各种请求到eureka注册中心，去测试各种功能
 *
 * @author Tomasz Bak
 */
public class EurekaClientServerRestIntegrationTest {
    ...
    private static void startServer() throws Exception {
        ...
        /**
         * 先把eureka-server打成一个war包，然后找到那个war包去启动
         * 每次都打包，耗费时间，不好调试
         */
...
//        eurekaServiceUrl = "http://localhost:8080/v2";
        ...
        /**
         * 直接就是自己加载eureka-server的各种资源，比如web.xml，配置文件啥的，然后直接就启动注册中心
         */
        server = new Server(8080);
